...
public class PokePlatPopTrackerInstaller : MonoBehaviour
{
    [Header("UI ELEMENTS")]
    ...
    public class RemoteConfig
    {
        ...
        public string pokemonplatinumPopTracker;
    }
    ...
    IEnumerator LoadRemoteConfig()
    {
        ...
        try
        {
            ...
            gamepackDownloadUrl = remoteConfig.pokemonplatinumPopTracker;
    ...
    IEnumerator DownloadAndInstall()
    {
        ...
        string packDestZipPath = Path.Combine(packsPath, "PokémonPlatinumAPPoptracker.zip");
