...
public class TUNICPopTrackerInstaller : MonoBehaviour
{
    [Header("UI ELEMENTS")]
    ...
    IEnumerator LoadRemoteConfig()
    {
        ...
        try
        {
            ...
            gamepackDownloadUrl = remoteConfig.tunicPopTracker;
    ...
    IEnumerator DownloadAndInstall()
    {
        ...
        string packDestZipPath = Path.Combine(packsPath, "TUNICAPPoptracker.zip");
