...
public class DOOMPopTrackerInstaller : MonoBehaviour
{
    [Header("UI ELEMENTS")]
    ...
    IEnumerator LoadRemoteConfig()
    {
        ...
        try
        {
            ...
            gamepackDownloadUrl = remoteConfig.doomPopTracker;
    ...
    IEnumerator DownloadAndInstall()
    {
        ...
        string packDestZipPath = Path.Combine(packsPath, "DOOMAPPoptracker.zip");
