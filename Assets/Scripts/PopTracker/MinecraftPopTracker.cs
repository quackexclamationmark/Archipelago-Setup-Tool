...
public class MinecraftPopTrackerInstaller : MonoBehaviour
{
    [Header("UI ELEMENTS")]
    ...
    public class RemoteConfig
    {
        ...
        public string minecraftPopTracker;
    }
    ...
    IEnumerator LoadRemoteConfig()
    {
        ...
        try
        {
            ...
            gamepackDownloadUrl = remoteConfig.minecraftPopTracker;
            Debug.Log("PopTracker config loaded successfully.");
            Debug.Log("PopTracker URL: " + poptrackerDownloadUrl);
            Debug.Log("Subnautica Pack URL: " + gamepackDownloadUrl);
        }
    ...
    IEnumerator DownloadAndInstall()
    {
        ...
        string packDestZipPath = Path.Combine(packsPath, "SubnauticaAPPoptracker.zip");
