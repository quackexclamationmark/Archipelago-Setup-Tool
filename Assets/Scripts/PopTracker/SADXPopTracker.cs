...
public class SADXPopTrackerInstaller : MonoBehaviour
{
    [Header("UI ELEMENTS")]
    ...
    IEnumerator LoadRemoteConfig()
    {
        ...
        try
        {
            ...
            gamepackDownloadUrl = remoteConfig.sadxPopTracker;
    ...
    IEnumerator DownloadAndInstall()
    {
        ...
        string packDestZipPath = Path.Combine(packsPath, "SonicADXAPPoptracker.zip");
