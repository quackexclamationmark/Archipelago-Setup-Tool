...
public class DS2PopTrackerInstaller : MonoBehaviour
{
    [Header("UI ELEMENTS")]
    ...
    IEnumerator LoadRemoteConfig()
    {
        ...
        try
        {
            ...
            gamepackDownloadUrl = remoteConfig.ds2PopTracker;
    ...
    IEnumerator DownloadAndInstall()
    {
        ...
        string packDestZipPath = Path.Combine(packsPath, "DS2APPoptracker.zip");
