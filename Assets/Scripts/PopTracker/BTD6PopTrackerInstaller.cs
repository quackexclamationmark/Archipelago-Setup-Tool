...
public class BTD6PopTrackerInstaller : MonoBehaviour
{
    [Header("UI ELEMENTS")]
    ...
    IEnumerator LoadRemoteConfig()
    {
        ...
        try
        {
            ...
            gamepackDownloadUrl = remoteConfig.btd6PopTracker;
    ...
    IEnumerator DownloadAndInstall()
    {
        ...
        string packDestZipPath = Path.Combine(packsPath, "BloonsTD6APPoptracker.zip");
