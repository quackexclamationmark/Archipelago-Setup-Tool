...
public class FuniPopTrackerInstaller : MonoBehaviour
{
    [Header("UI ELEMENTS")]
    ...
    public class RemoteConfig
    {
        ...
        public string funiraccoonPopTracker;
    }
    ...
    IEnumerator LoadRemoteConfig()
    {
        ...
        try
        {
            ...
            gamepackDownloadUrl = remoteConfig.funiraccoonPopTracker;
    ...
    IEnumerator DownloadAndInstall()
    {
        ...
        string packDestZipPath = Path.Combine(packsPath, "FuniRaccoonGameAPPoptracker.zip");
