...
public class SchedulePopTrackerInstaller : MonoBehaviour
{
    [Header("UI ELEMENTS")]
    ...
    public class RemoteConfig
    {
        ...
        public string schedulePopTracker;
    }
    ...
    IEnumerator LoadRemoteConfig()
    {
        ...
        try
        {
            ...
            gamepackDownloadUrl = remoteConfig.schedulePopTracker;
            Debug.Log("PopTracker config loaded successfully.");
            Debug.Log("PopTracker URL: " + poptrackerDownloadUrl);
            Debug.Log("Outer Wilds Pack URL: " + gamepackDownloadUrl);
        }
    ...
    IEnumerator DownloadAndInstall()
    {
        ...
        string packDestZipPath = Path.Combine(packsPath, "ScheduleIPopTracker.zip");
