...
public class Portal2PopTrackerInstaller : MonoBehaviour
{
    [Header("UI ELEMENTS")]
    ...
    public class RemoteConfig
    {
        ...
        public string portal2PopTracker;
    }
    ...
    IEnumerator LoadRemoteConfig()
    {
        ...
        try
        {
            ...
            gamepackDownloadUrl = remoteConfig.portal2PopTracker;
    ...
    IEnumerator DownloadAndInstall()
    {
        ...
        string packDestZipPath = Path.Combine(packsPath, "Portal2APPoptracker.zip");
