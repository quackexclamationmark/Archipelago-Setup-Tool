...
public class TWCManualDL : MonoBehaviour
{
    ...
    IEnumerator InstallAPWorld()
    {
        ...
        UnityEngine.Debug.Log("Config loaded. APWorld URL: " + thewerecleanerApworld.url);

        if (string.IsNullOrEmpty(thewerecleanerApworld.url))
        {
        ...
        {
            fileName = thewerecleanerApworld.url.Substring(thewerecleanerApworld.url.LastIndexOf('/') + 1);
        ...
        UnityEngine.Debug.Log("Downloading APWorld from: " + thewerecleanerApworld.url);
        UnityEngine.Debug.Log("Saving to: " + localPath);

        yield return DownloadFile(thewerecleanerApworld.url, localPath);
