...
public class SlimeRancher2ManualDL : MonoBehaviour
{
    ...
    private void ExecuteSetup()
    {
        ...
        {
            ShowInfo("Slime Rancher 2 path not found. Please check Steam installation.");
            return;
        }
    ...
    {
        string url = "https://raw.githubusercontent.com/quackexclamationmark/Archipelago-Setup-Tool/refs/heads/main/RemoteConfig/slimerancher2_config.json";
    ...
    string GetSlimeRancher2Path()
    {
        ...
        foreach (string path in quickPaths)
        {
            try
            {
                if (Directory.Exists(path))
                {
                    UnityEngine.Debug.Log("Found Slime Rancher 2 at: " + path);
                    return path;
                }
            }
            catch { }
        ...
        UnityEngine.Debug.LogWarning("Slime Rancher 2 not found.");
        return "";
    }
