...
public class HereticManualDL : MonoBehaviour
{
    public FileDownloader downloader;

    [Header("GAME FILES")]
    public FileDownloader.FileData hereticAP;

    [Header("GAME FOLDER NAMES")]
    public string steamGameFolderName = "Heretic + Hexen";
    ...
    void ApplyGameConfig()
    {
        ...
        hereticAP.url = remoteConfig.hereticAP;
    }
    ...
    IEnumerator InstallDoomArchipelago()
    {
        ...
        yield return downloader.DownloadAndExtract(hereticAP, Application.persistentDataPath, extractPath);
        ...
        CreateVersionFile(hereticAP.url);
    ...
    public void CopyWadFiles()
    {
        ...
        {
            ShowInfo("Heretic + Hexen install not found. Please check your Steam installation.");
            return;
        }

        string hereticWadSource = Path.Combine(gamePath, "heretic.wad");

        if (!File.Exists(hereticWadSource))
        {
            ShowInfo("heretic.wad not found at:\n" + hereticWadSource);
            return;
        }
        ...
        try
        {
            ...
            string hereticWadTarget = Path.Combine(DoomArchipelagoPath, "heretic.wad");

            File.Copy(hereticWadSource, hereticWadTarget, true);

            ShowInfo("WAD files copied successfully!");
            UnityEngine.Debug.Log("Copied heretic.wad at: " + DoomArchipelagoPath);
        }
        catch (System.Exception e)
        {
